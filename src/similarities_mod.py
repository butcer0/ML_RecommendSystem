...
def getTopN(movie_index, numReturn, *args):
    ...
    current_movie_features = M[movie_id]
    ...
    print("The {} most similar movies are:".format(numReturn))
    #print(sorted_movie_list[['title', 'difference_score']][0:numReturn])
    return sorted_movie_list[0:numReturn]